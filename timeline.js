...
void function( exports ){
   ...
   * configs
   */
  var speed = 1; // running speed rate
  ...
  ClassTimeline.prototype.setTimeout = function( fn, time ){
    return this.createTask( { start: time } ).handleStart( fn );
  };
  ...
  ClassTimeline.prototype.clearTasks = function(){
    var tasks = this.tasks, addingTasks = this.addingTasks;
  ...
  exports.use = function( name ){
    ...
    if( timeline = this.caches[ name ] )
      return timeline;
    else
      return this.caches[ name ] = ClassTimeline.create();
  };
  ...
  return typeof exports != "undefined" ? exports : global.Timeline = {}; 
}( this ) );